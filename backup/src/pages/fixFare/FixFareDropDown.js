...
function FixFareDropDown({ val, getVal, onChange, name }) {
  return (
    <div>
      {val === "Address" && (
        <div className="commonDiv">
          <label className="nameLbl comonLblmrgn">Select Address</label>
      ...
      {val === "Post Code" && (
        <div className="commonDiv">
          <label className="nameLbl comonLblmrgn">Select Post Code</label>
      ...
      {val === "Cruise Port" && (
        <div className="commonDiv">
          <label className="nameLbl comonLblmrgn">Select Cruise Port</label>
          ...
          >
            ...
            <option value="25684">PORTSMOUTH PORT PO2 8SP</option>
            <option value="25685">HARWICH PORT CO12 4SR</option>
            <option value="25686">DOVER PORT CT17 9DQ</option>
            <option value="25687">TILBURY PORT RM18 7NG</option>
            <option value="3972">TYNE DOCKS NE34 9PT</option>
          </select>
        </div>
      )}
      {val === "Station" && (
...
export default FixFareDropDown;
