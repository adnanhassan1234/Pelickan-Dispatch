...
function Account() {
  ...
  return (
    <div className="main--account__display">
      <div className="driver--dash__ms account--main__left">
      ...
      <div className="mid--account__display">
        <div className="driver--dash__ms account--main__rgtone">
          <div className="all--first__tble table__top account--nav__last">
            <TableHeadFilter
              tableRef={tableOperator}
              id=""
              nId={{}}
