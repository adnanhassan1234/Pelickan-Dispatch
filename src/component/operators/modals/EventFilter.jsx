...
function EventFilter({ onOpenModal }) {
  const data = [
    {
  ...
  return (
    <div className="attributes__container event__filter">
      ...
      <div>
        <Paragraph
          label="Release Note:"
          text="Any events created by this Operator will always be visible, regardless of which event types are selected here."
          id="releasenote"
          visibility="visible"
        />
      </div>
